...
gnome-terminal --tab -- bash -c "echo \"image_transport compressed to raw\" && sleep 2 && rosrun image_transport republish compressed in:=/camera/image_raw raw out:=/camera/image_raw"
